...
if(isset($_POST['loginButton'])){
	...
	if(strlen($password) < 4){
		$passShortErr = "Password should be at least 4 charactors!";
	}
						...
						<input type="hidden" name="_token" value="<?php echo $_SESSION['_token'] ?>">
							<div class="col-md-12 form-group">
								<input type="text" id="name" name="email" 
									   ...
									   class="form-control <?php if($emailErr){echo 'border border-danger';} ?>">
							...
							<div class="col-md-12 form-group">
								...
								<i class="text-danger"><?php if($passErr){echo $passErr;}elseif($passShortErr){echo $passShortErr;} ?></i>
							</div>
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" name="loginButton" class="primary-btn">Log In</button>
							</div>
						</form>
					</div>
				</div>
